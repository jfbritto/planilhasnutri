$(document).ready(function () {
    ...
    $("#list").on("click", ".edit-recebimento_materia_prima", function(){
        ...
        loadGlobalParameters(8, 'id_parameter_produto_edit', id_parameter_produto, false, true, `modalEditrecebimento_materia_prima`);
        loadGlobalParameters(10, 'id_parameter_fornecedor_edit', id_parameter_fornecedor, false, true, `modalEditrecebimento_materia_prima`);
        loadGlobalParameters(3, 'id_parameter_responsavel_edit', id_parameter_responsavel, false, true, `modalEditrecebimento_materia_prima`);
