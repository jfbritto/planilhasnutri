        ...
        <table class="table table-bordered table-striped">
            <thead>
                <tr>
                    <th>Data</th>
                    <th>Produto</th>
                    <th colspan="2">Temperatura Antes Do Aquecimento</th>
                    <th colspan="2">Temperatura Após Do Aquecimento</th>
                    <th>Tempo de Aquecimento</th>
                    <th>Conforme?</th>
                    <th>Responsável</th>
                </tr>
                <tr>
            ...
            <tbody>
                @foreach($itens as $item)
                    <tr>
                        ...
                        <td style="vertical-align: middle">{{ $item->hora_temperatura_antes }}</td>
                        <td style="vertical-align: middle">{{ $item->temperatura_antes }}</td>
                        <td style="vertical-align: middle">{{ $item->hora_temperatura_depois }}</td>
                        <td style="vertical-align: middle">{{ $item->temperatura_depois }}</td>
                        <td style="vertical-align: middle">{{ $item->tempo_aquecimento }}</td>
