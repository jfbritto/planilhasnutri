        ...
        <table class="table table-bordered table-striped">
            ...
            <tbody>
                @foreach($itens as $item)
                    <tr>
                        <td>{{ \Carbon\Carbon::parse($item->data_congelamento)->format('d/m/Y') }}</td>
                        <td>{{ $item->produto }}</td>
                        <td>{{ $item->quantidade }}</td>
                        <td>{{ \Carbon\Carbon::parse($item->data_recebimento)->format('d/m/Y') }}</td>
                        <td>{{ \Carbon\Carbon::parse($item->data_fabricacao)->format('d/m/Y') }}</td>
                        <td>{{ $item->alergeno }}</td>
                    </tr>
                @endforeach
            </tbody>
