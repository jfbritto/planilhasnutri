...
@section('content_header')
    <div class="row">
        <div class="col-sm-9">
            <h1 class="d-none d-md-block"><i class="fa-solid fa-snowflake"></i> &nbsp;Registro de Congelamento</h1>
            <h4 class="d-block d-sm-block d-md-none"><i class="fa-solid fa-snowflake"></i> &nbsp;Registro de Congelamento</h4>
        </div>
        <div class="col-sm-3">
...
@section('content')
    ...
    <div class="modal fade"  role="dialog" id="modalStoreregistro_congelamento">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="id_parameter_alergeno" id="id_parameter_alergeno" class="form-control selecao-customizada"></select>
                            </div>
                        </div>
                    </div>
                </form>
    ...
    <div class="modal fade"  role="dialog" id="modalEditregistro_congelamento">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
            <div class="modal-header">
