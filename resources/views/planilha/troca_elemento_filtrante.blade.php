...
@section('content_header')
    <div class="row">
        <div class="col-sm-9">
            <h1 class="d-none d-md-block"><i class="fa-solid fa-filter-circle-xmark"></i> &nbsp;Controle de Troca do Elemento Filtrante</h1>
            <h4 class="d-block d-sm-block d-md-none"><i class="fa-solid fa-filter-circle-xmark"></i> &nbsp;Controle de Troca do Elemento Filtrante</h4>
        </div>
        <div class="col-sm-3">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="date" name="data_ini_filter" id="data_ini_filter" class="form-control">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="mes_proxima_troca_filter">Próxima troca</label>
                            <input type="month" name="mes_proxima_troca_filter" id="mes_proxima_troca_filter" class="form-control">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="id_parameter_filtro_filter">Filtro</label>
                            <select name="id_parameter_filtro_filter" id="id_parameter_filtro_filter" class="form-control"></select>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="id_parameter_responsavel_filter">Responsável</label>
