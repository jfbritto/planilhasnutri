...
@section('content_header')
    <div class="row">
        <div class="col-sm-9">
            <h1 class="d-none d-md-block"><i class="fa-solid fa-triangle-exclamation"></i> &nbsp;Registro de Não Conformidades Detectadas na Auto Avaliação</h1>
            <h4 class="d-block d-sm-block d-md-none"><i class="fa-solid fa-triangle-exclamation"></i> &nbsp;Registro de Não Conformidades Detectadas na Auto Avaliação</h4>
        </div>
        <div class="col-sm-3">
