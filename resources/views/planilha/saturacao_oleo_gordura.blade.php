...
@section('content_header')
    <div class="row">
        <div class="col-sm-9">
            <h1 class="d-none d-md-block"><i class="fa-solid fa-droplet"></i> &nbsp;Controle de Saturação de Óleos e Gorduras</h1>
            <h4 class="d-block d-sm-block d-md-none"><i class="fa-solid fa-droplet"></i> &nbsp;Controle de Saturação de Óleos e Gorduras</h4>
        </div>
        <div class="col-sm-3">
