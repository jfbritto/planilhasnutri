...
@section('content_header')
    <h1><i class="fas fa-file"></i> &nbsp;Controle de Temperatura dos Alimentos no Banho-Maria</h1>
@stop
        ...
        <div class="card-header border-0">
            @if(auth()->user()->id_unit)
                ...
                <div class="card-tools">
                    <a href="#" class="btn btn-tool btn-sm" data-toggle="modal" data-target="#modalStoretemperatura_alimento_banho_maria">
