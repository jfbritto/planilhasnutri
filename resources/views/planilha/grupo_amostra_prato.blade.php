...
@section('content_header')
    <div class="row">
        <div class="col-sm-9">
            <h1 class="d-none d-md-block"><i class="fa-solid fa-plate-wheat"></i> &nbsp;Registro de Grupo de Amostras de Pratos</h1>
            <h4 class="d-block d-sm-block d-md-none"><i class="fa-solid fa-plate-wheat"></i> &nbsp;Registro de Grupo de Amostras de Pratos</h4>
        </div>
        <div class="col-sm-3">
