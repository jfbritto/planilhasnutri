...
@section('content_header')
    <div class="row">
        <div class="col-sm-9">
            <h1 class="d-none d-md-block"><i class="fa-solid fa-temperature-arrow-down"></i> &nbsp;Controle de Resfriamento Rápido de Alimentos</h1>
            <h4 class="d-block d-sm-block d-md-none"><i class="fa-solid fa-temperature-arrow-down"></i> &nbsp;Controle de Resfriamento Rápido de Alimentos</h4>
        </div>
        <div class="col-sm-3">
